    ...
    <div className="flex h-screen overflow-hidden bg-zinc-50 dark:bg-zinc-950">
      ...
      <aside className="hidden w-64 flex-col border-r bg-white dark:bg-zinc-900 md:flex">
        ...
        <div className="border-t p-4">
          <Link href="/settings" className="flex items-center gap-3 rounded-md px-3 py-2 text-zinc-700 hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-zinc-800">
            <Settings className="h-5 w-5" />
            <span>Settings</span>
          </Link>
          <button className="flex w-full items-center gap-3 rounded-md px-3 py-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30">
